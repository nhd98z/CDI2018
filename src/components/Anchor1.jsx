    ...
    return (
      <aside id="anchor1">
        <div className="fa_background">
          <div className="fa">
            <div className="fa_big_hulb_section fa_big_hulb_section_animate">
              <img id="big_hulb" src={light_bulb} alt="light_bulb" />
            </div>
            <div className="fa_content_section row">
              <h2 className="fa_vsl fa_vsl_animate">Vòng sơ loại</h2>
              <h1 className="fa_nyt fa_nyt_animate">Nộp ý tưởng</h1>
              ...
              <h1 className="fa_number fa_number_animate">
              ...
              <h3 className="fa_ngaygio fa_ngaygio_animate">
                Ngày&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                Giờ&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                Phút&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Giây
              </h3>
              <input
                type="button"
                className="fa_btn fa_btn_animate"
                value="ĐĂNG KÝ NGAY"
